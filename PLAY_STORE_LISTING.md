...
- `public/play-store/app-icon-512.png` — 512 × 512 app icon
- `public/play-store/feature-graphic.png` — 1024 × 500 feature graphic
- `public/play-store/screenshot-practice-1920x1080.png` — practice screenshot
- `public/play-store/screenshot-mock-test-1920x1080.png` — mock-test screenshot

## Details still requiring owner confirmation

- Public support/contact email
- Content-rating contact email
- Google Play reviewer account email and password
- App privacy-policy contact method
