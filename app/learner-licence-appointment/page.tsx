      ...
      <section className="content-page">
        <div className="shell content-grid">
          ...
          <div className="prose">
            ...
            <div className="callout"><b>Do not rely on an old checklist.</b> Bring the documents and fees confirmed by your local centre, and check the appointment receipt carefully. Requirements and availability can change. <Link className="text-link" href="/learner-licence-appointment-documents/">See the appointment document checklist →</Link></div>
            <h2 id="four-weeks">A four-week plan from appointment to test day</h2>
            <p>If your appointment gives you roughly a month before you write, use the weeks like this. If you have more or less time, stretch or compress the same sequence. <Link className="text-link" href="/four-week-learner-licence-study-plan/">Open the detailed four-week study plan →</Link></p>
