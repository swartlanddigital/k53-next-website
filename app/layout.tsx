...
export const metadata: Metadata = {
  ...
  title: { default: "K53 Next | Prepare for the New Computerised Learner's Test", template: "%s | K53 Next" },
  ...
  openGraph: { type:"website", locale:"en_ZA", siteName:"K53 Next", title:"The learner's test changed. Your prep should too.", description:"Prepare for the new computerised learner's licence test with 1,574 screen-based K53 questions, image-based signs and timed mock tests.", images:[{url:"/og.png",width:1732,height:909,alt:"K53 Next — The test changed. Your prep should too."}] },
