...
export const metadata: Metadata = {
  ...
  description: "Read the K53 Fast terms of service and educational disclaimer.",
  alternates: { canonical: "/terms/" },
};

export default function Page() {
  return <><Header/><main id="main"><PageHero eyebrow="USE IT WELL" title="Clear terms. No surprise turns." lede="The rules for using the K53 Fast app, website and study resources."/><article className="content-page"><div className="shell narrow prose">
    <span className="legal-date">Effective 13 July 2026</span>
    <h2>Agreement</h2><p>These Terms of Service apply to the K53 Fast Android application, web application and marketing website. By creating an account or using K53 Fast, you agree to these terms and our Privacy Policy. If you do not agree, do not use the service.</p>
    <h2>Educational purpose and independent status</h2><p>K53 Fast is an independent educational study tool. It is not affiliated with, endorsed by or operated by the South African government, a Driving Licence Testing Centre or any licensing authority. K53 Fast does not issue licences, accept test bookings or act on behalf of a licensing authority.</p>
    ...
    <h2>Acceptable use</h2><p>You may use K53 Fast for lawful personal study. You may not:</p><ul><li>Disrupt, overload, damage or bypass the service or its security.</li><li>Use automated tools to scrape, copy or extract the question bank.</li><li>Reproduce, sell, sublicense or commercially distribute K53 Fast content without written permission.</li><li>Upload malicious code or use the service for unlawful activity.</li><li>Reverse engineer the service except where applicable law expressly permits it.</li></ul>
    <h2>Content and intellectual property</h2><p>K53 Fast and its original software, branding, layouts, question-bank compilation, explanations and other content are protected by applicable intellectual-property laws. These terms give you a limited, personal, non-exclusive and revocable right to use the service; they do not transfer ownership to you.</p>
    <h2>Availability and changes</h2><p>We may maintain, update, add to, suspend or discontinue parts of K53 Fast. We work to keep the service useful and available but do not promise uninterrupted or error-free operation. We may correct content or reset features where reasonably necessary for security, maintenance or data integrity.</p>
    <h2>Suspension and termination</h2><p>You may stop using K53 Fast and request account deletion at any time. We may restrict or terminate access where you materially breach these terms, create security or legal risk, or misuse the service. Provisions that by their nature should continue after termination will survive.</p>
    <h2>Third-party services</h2><p>K53 Fast relies on third-party hosting, authentication, app-store and infrastructure services. Those services may have their own terms. We are not responsible for third-party services outside our control.</p>
    <h2>Disclaimer and limitation of liability</h2><p>K53 Fast is provided on an “as is” and “as available” basis to the extent permitted by law. We do not warrant that every question, explanation or readiness estimate will always be complete, current or free from error. To the extent permitted by law, K53 Fast will not be liable for indirect, incidental or consequential loss arising from use of, inability to use or reliance on the service. Nothing in these terms excludes rights or liability that cannot legally be excluded, including rights under applicable consumer law.</p>
